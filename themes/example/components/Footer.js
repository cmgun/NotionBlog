        ...
        <div className="container mx-auto max-w-4xl py-6 md:flex flex-wrap md:flex-no-wrap md:justify-between items-center text-sm">
            ...
            <div className='text-center'>
              <a href="https://hits.seeyoufarm.com">
                <img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fcmgun.cc&count_bg=%2379C83D&title_bg=%23E311A3&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false"/>
              </a>
            </div>
        </div>
    </footer>
